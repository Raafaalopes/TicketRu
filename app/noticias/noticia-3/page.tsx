...
export default function Noticia3Page() {
  return (
    <NoticiaDetalhada
      ...
      conteudo={`O TicketRu agora oferece mais funcionalidades para facilitar sua experiência. Entre as novidades, destacamos a compra mais rápida de tickets, a personalização do cardápio e a opção de pagamento por PIX.
